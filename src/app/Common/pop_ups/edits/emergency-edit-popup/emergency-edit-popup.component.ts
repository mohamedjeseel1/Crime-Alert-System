...
export class EmergencyEditPopupComponent implements OnInit {
  ...
  constructor(private service:EmergencyService,@Inject(MAT_DIALOG_DATA) public data:any ,) { }
  ...
  updateAlert(){
    this.service.updateEmergency(this.emergencyAlert.value, this.data.alert.id ).subscribe((data)=>{
